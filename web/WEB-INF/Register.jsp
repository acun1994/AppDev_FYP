...
<html>
    ...
    <div style="height: auto" id="WrapperBodyRegister">
     ...
     <fieldset>
  <legend class="text-uppercase" style="font-family: fantasy;font-size: 2.5em">&emsp;Sign Up</legend>  
  <div id="studname-group" class="form-group">
    <div class="col-xs-9 col-xs-offset-1 input-group">
    ...
    <h5 hidden class="col-xs-9 col-xs-offset-4"  id="namestat" style="color:red;padding-bottom: 0px">This field is required</h5>
  </div>
 <div id="matric-group" class="form-group">
    <div class="col-xs-9 col-xs-offset-1 input-group">
     ...
     <h5 hidden class="col-xs-9 col-xs-offset-4"  id="matricstat2" style="color:red;padding-bottom: 0px">This field is required</h5>
     <h5 hidden class="col-xs-9 col-xs-offset-4"  id="matricstat3" style="color:red;padding-bottom: 0px">Matric No. not valid</h5>
  </div>
 <div id="department-group" class="form-group">
    <div class="col-xs-9 col-xs-offset-1 input-group">
     ...
     <h5 hidden class="col-xs-9 col-xs-offset-4"  id="departmentstat2" style="color:red;padding-bottom: 0px">This field is required</h5>
     
  </div>
 <div id="ic-group" class="form-group">
    <div class="col-xs-9 col-xs-offset-1 input-group">
        <div  class="input-group-addon">IC&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;</div>
      <input id="ic" type="text" class="form-control" placeholder="Enter IC No" name="ic_no" onblur="javascript:validateInline(this.id, this.value)" >
      <span id="icstat" class="glyphicon form-control-feedback" aria-hidden="true"></span>
    
      
        </div>
     <h5 hidden class="col-xs-9 col-xs-offset-4"  id="icstat2" style="color:red;padding-bottom: 0px">This field is required</h5>
     <h5 hidden class="col-xs-9 col-xs-offset-4"  id="icstat3" style="color:red;padding-bottom: 0px">IC No. not valid</h5>
  </div>
  <div id="contact-group" class="form-group">
    <div class="col-xs-9 col-xs-offset-1 input-group">
      ...
      <h5 hidden class="col-xs-9 col-xs-offset-4"  id="contactstat2" style="color:red;padding-bottom: 0px">This field is required</h5>
      <h5 hidden class="col-xs-9 col-xs-offset-4"  id="contactstat3" style="color:red;padding-bottom: 0px">Phone Number Invalid Format</h5>
  </div>
 <div id="email-group" class="form-group">
    <div class="col-xs-9 col-xs-offset-1 input-group">
     ...
     <h5 hidden class="col-xs-9 col-xs-offset-4"  id="emailstat2" style="color:red;padding-bottom: 0px">This field is required</h5>
     <h5 hidden class="col-xs-9 col-xs-offset-4"  id="emailstat3" style="color:red;padding-bottom: 0px">Invalid email address format</h5>
  </div>
 <div id="pass-group" class="form-group">
    <div class="col-xs-9 col-xs-offset-1 input-group">
     ...
     <h5 hidden class="col-xs-9 col-xs-offset-4"  id="passstat2" style="color:red;padding-bottom: 0px">This field is required</h5>
  </div>
  <div id="passcom-group" class="form-group">
    <div class="col-xs-9 col-xs-offset-1 input-group">
      ...
      <h5 hidden class="col-xs-9 col-xs-offset-4"  id="passcomstat2" style="color:red;padding-bottom: 0px">This field is required</h5>
      <h5 hidden class="col-xs-9 col-xs-offset-4"  id="pswcom" style="color:red;padding-bottom: 0px">Password does not match</h5>
  </div>
