	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbar-collapse-1">
			<ul class="nav navbar-nav">
				<li class="active"><a href="./ServMenu?Page=Home">Home</a></li>
				<li><a href="#" >Contact Us</a></li>
                    ...
                    <ul style="float:right;padding-top: 9px" class="nav navbar-nav">
                      <li class="dropdown">
					<button class="btn btn-primary" data-toggle="modal" onclick="openLoginModal();" >&emsp;Sign In&emsp;<i class="glyphicon glyphicon-user"></i></button>
